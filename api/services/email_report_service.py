...
_GITHUB_URL = "https://github.com/25283531/TradingAgents-AShare"
...
def render_report_html(report: "ReportDB", frontend_url: str = "", stock_name: str = "") -> str:
    ...
    parts.append(
        ...
        f' 或 '
        f'<a href="https://gupiao.hnpds.eu.org:32123/sponsor" style="color:#3b82f6;text-decoration:none;">&#10084;&#65039; 赞助支持</a>'
        f'</p>'
