...
const REPORT_SECTION_TITLES: Record<string, string> = {
    ...
    sector_report: '行业轮动分析报告',
    anti_quant_report: '防量化陷阱分析报告',
...
const SECTION_META: Record<string, { Icon: React.FC<{ className?: string }>; iconCls: string; bgCls: string }> = {
    ...
    sector_report:          { Icon: ArrowBigUp,    iconCls: 'text-lime-500',    bgCls: 'bg-lime-100 dark:bg-lime-500/20' },
    anti_quant_report:      { Icon: Shield,        iconCls: 'text-slate-500',   bgCls: 'bg-slate-100 dark:bg-slate-500/20' },
